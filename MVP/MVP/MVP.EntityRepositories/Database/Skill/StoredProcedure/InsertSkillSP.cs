...
{
    class InsertSkillSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public InsertSkillSP(string connectionString, RequestInput<SkillEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = SkillProcedureNames.InsertSkill;
        ...
        {
            InsertSkillSP sp = new InsertSkillSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
