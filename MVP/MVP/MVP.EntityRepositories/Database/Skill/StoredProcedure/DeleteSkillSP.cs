...
{
    class DeleteSkillSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public DeleteSkillSP(string connectionString, RequestInput<SkillEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = SkillProcedureNames.DeleteSkill;
        ...
        public static DataSourceRequestEntities<bool> Execute(RequestInput<SkillEntity> ObjRequestInput)
        {
            DeleteSkillSP sp = new DeleteSkillSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
        ...
        /// <param name="ObjRequestInput"></param>
        /// <returns>AddressEntity with DataSourceRequestEntities</returns>
        public static async Task<DataSourceRequestEntities<bool>> ExecuteAsync(RequestInput<SkillEntity> ObjRequestInput)
        {
            DeleteSkillSP sp = new DeleteSkillSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
