...
{
    class UpdateSkillSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public UpdateSkillSP(string connectionString, RequestInput<SkillEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = SkillProcedureNames.UpdateSkill;
        ...
        {
            UpdateSkillSP sp = new UpdateSkillSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
