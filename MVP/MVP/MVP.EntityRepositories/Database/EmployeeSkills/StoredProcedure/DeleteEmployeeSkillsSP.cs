...
{
    class DeleteEmployeeSkillsSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public DeleteEmployeeSkillsSP(string connectionString, RequestInput<EmployeeSkillsEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = EmployeeSkillsProcedureNames.DeleteEmployeeSkills;
        ...
        public static DataSourceRequestEntities<bool> Execute(RequestInput<EmployeeSkillsEntity> ObjRequestInput)
        {
            DeleteEmployeeSkillsSP sp = new DeleteEmployeeSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
        ...
        /// <param name="ObjRequestInput"></param>
        /// <returns>AddressEntity with DataSourceRequestEntities</returns>
        public static async Task<DataSourceRequestEntities<bool>> ExecuteAsync(RequestInput<EmployeeSkillsEntity> ObjRequestInput)
        {
            DeleteEmployeeSkillsSP sp = new DeleteEmployeeSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
