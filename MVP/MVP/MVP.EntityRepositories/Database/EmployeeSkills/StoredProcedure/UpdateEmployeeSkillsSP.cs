...
{
    class UpdateEmployeeSkillsSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public UpdateEmployeeSkillsSP(string connectionString, RequestInput<EmployeeSkillsDtEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = EmployeeSkillsProcedureNames.UpdateEmployeeSkills;
        ...
        {
            UpdateEmployeeSkillsSP sp = new UpdateEmployeeSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
