...
{
    class DeleteEmployeeSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public DeleteEmployeeSP(string connectionString, RequestInput<EmployeeEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = EmployeeProcedureNames.DeleteEmployee;
        ...
        {
            DeleteEmployeeSP sp = new DeleteEmployeeSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
