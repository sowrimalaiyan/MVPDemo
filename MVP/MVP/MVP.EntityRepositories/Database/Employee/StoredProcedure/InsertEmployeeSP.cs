...
{
    class InsertEmployeeSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public InsertEmployeeSP(string connectionString, RequestInput<EmployeeEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = EmployeeProcedureNames.InsertEmployee;
        ...
        {
            InsertEmployeeSP sp = new InsertEmployeeSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
