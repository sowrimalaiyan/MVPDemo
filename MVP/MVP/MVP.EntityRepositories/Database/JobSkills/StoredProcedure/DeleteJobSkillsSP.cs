...
{
    public class DeleteJobSkillsSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public DeleteJobSkillsSP(string connectionString, RequestInput<JobSkillsEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = JobSkillsProcedureNames.DeleteJobSkills;
        ...
        public static DataSourceRequestEntities<bool> Execute(RequestInput<JobSkillsEntity> ObjRequestInput)
        {
            DeleteJobSkillsSP sp = new DeleteJobSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
        ...
        /// <param name="ObjRequestInput"></param>
        /// <returns>AddressEntity with DataSourceRequestEntities</returns>
        public static async Task<DataSourceRequestEntities<bool>> ExecuteAsync(RequestInput<JobSkillsEntity> ObjRequestInput)
        {
            DeleteJobSkillsSP sp = new DeleteJobSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
