...
{
    class InsertJobSkillsSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public InsertJobSkillsSP(string connectionString, RequestInput<JobSkillsDtEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = JobSkillsProcedureNames.InsertJobSkills;
        ...
        {
            InsertJobSkillsSP sp = new InsertJobSkillsSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
