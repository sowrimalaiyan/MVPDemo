...
{
    class InsertJobSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public InsertJobSP(string connectionString, RequestInput<JobEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = JobProcedureNames.InsertJob;
        ...
        {
            InsertJobSP sp = new InsertJobSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
