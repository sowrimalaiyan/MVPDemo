...
{
    class UpdateJobSP : StoreProcHavingOutputParam
    {
        #region Constants        
        ...
        public UpdateJobSP(string connectionString, RequestInput<JobEntity> ObjRequestInput)
            : base(connectionString)
        {
            StoreProcName = JobProcedureNames.UpdateJob;
        ...
        {
            UpdateJobSP sp = new UpdateJobSP(ObjRequestInput.ClientUserInfo.ConnectionString, ObjRequestInput);
            sp.ExecuteSP();
